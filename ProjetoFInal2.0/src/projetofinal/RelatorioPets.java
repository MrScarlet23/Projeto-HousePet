...
public class RelatorioPets extends JFrame
{
   ...
   private CadastroPetsBD CadastroPetsBD;
   
   
   public RelatorioPets()
   {
      
	   CadastroPets = new CadastroPets();
	   CadastroPetsBD = new CadastroPetsBD();
	   ...
	   CadastroPetsBD.MostrarPets(CadastroPets, modelo);
